...
class BookUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_user" do
    assert_difference('BookUser.count') do
      post book_users_url, params: { book_user: { book_id: @book_user.book_id, user_id: @book_user.user_id } }
    end
  ...
  test "should update book_user" do
    patch book_user_url(@book_user), params: { book_user: { book_id: @book_user.book_id, user_id: @book_user.user_id } }
