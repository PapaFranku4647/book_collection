class UserBooksController < ApplicationController
  before_action :set_user_book, only: %i[ show edit update destroy confirm_delete ]
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_books_url, status: :see_other, notice: "User book was successfully destroyed." }
      format.json { head :no_content }
    end
  end

  # GET /user_books/1/confirm_delete
  def confirm_delete
  end
